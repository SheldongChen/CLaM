...
def get_args_parser():
    ...
    ## vqvae2   
    parser.add_argument('--use-vqvae2', action='store_true', help='whether use vqvae2 quantizer')
    parser.add_argument('--straight_through', action='store_true', help='whether use straight_through for vqvae2')
    parser.add_argument('--reinmax', action='store_true', help='whether use reinmax for vqvae2')
    parser.add_argument('--starting_temp', type = float, default = 1., help = 'starting temperature')
    parser.add_argument('--temp_min', type = float, default = 0.01, help = 'minimum temperature to anneal to')
    parser.add_argument('--anneal_rate', type = float, default = 2e-5, help = 'temperature annealing rate')
    
    ##
    parser.add_argument('--use-texttransformer', action='store_true', help='whether use texttransformer')
    parser.add_argument('--pass-exists', action='store_true', help='pass exists npy files')
    parser.add_argument('--wrapper_opt_use_transformers', action='store_true', help='whether use transformer for eval')
    parser.add_argument("--choice_percent", type=int, default=None, help="percent of real text, such as 20/40/60/80")
    ...
    #double block_size
    parser.add_argument('--double_block_size', action='store_true', help='double block size')
    parser.add_argument('--eval_regenerate', action='store_true', help='regenerate for eval')
