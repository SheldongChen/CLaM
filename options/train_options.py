...
class TrainTexMotMatchOptions():
    def __init__(self):
        ...
        self.parser.add_argument('--max_epoch', type=int, default=200, help='Training iterations')
        self.parser.add_argument('--estimator_mod', type=str, default='bigru')
        self.parser.add_argument('--feat_bias', type=float, default=5, help='Layers of GRU')
        ...
        self.parser.add_argument('--use_transformers', action="store_true", help='Training with transformers encoder')
        self.parser.add_argument('--use_transformers_pretrain', action="store_true", help='Training with transformers pretrain')
        self.parser.add_argument('--movement_encoder_train', action="store_true", help='set movement encoder train')

        #AdamW optim
        self.parser.add_argument('--use_adamw', action="store_true", help='Training with AdamW optim')
        self.parser.add_argument('--adamw_weight_decay', type=float, default=1e-4, help='weight decay of AdamW')
        self.parser.add_argument('--beta1', type=float, default=0.9, help='beta1 of Adam')
        self.parser.add_argument('--beta2', type=float, default=0.999, help='beta2 decay of Adam')
        self.parser.add_argument('--eps', type=float, default=1e-8, help='eps of Adam')

        #infoNCE optim
        self.parser.add_argument('--tau', type=float, default=0.1, help='tau of infoNCE')
        self.parser.add_argument('--alpha', type=float, default=0.5, help='alpha of infoNCE')
